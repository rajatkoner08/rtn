...
from config import ModelConfig, FG_FRACTION, RPN_FG_FRACTION, DATA_PATH, BOX_SCALE, scale, PROPOSAL_FN
...
for val_b, b in enumerate(tqdm(val_loader)):
    ...
    boxes_np = det_result.boxes_assigned.data.cpu().numpy() * BOX_SCALE / scale
