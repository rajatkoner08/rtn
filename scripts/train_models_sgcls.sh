...
if [ $1 == "0" ]; then
    ...
    python models/train_rels.py -m sgcls -model motifnet -order leftright -nl_obj 2 -nl_edge 4 -b 6 -clip 5 \
        -p 100 -hidden_dim 512 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -ckpt /home/koner/data/checkpoints/neural_motif/vgrel-motifnet-sgdet.tar \
        -save_dir /home/koner/data/checkpoints/motifnet2 -nepoch 50 -use_bias
fi
