...
from lib.transformer.SubLayers import MultiHeadAttention, PositionwiseFeedForward
...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, d_inner, n_head, d_k, d_v, e2e= True, dropout=0.1, comb_type=None):
        super(DecoderLayer, self).__init__()
        if e2e:
            if comb_type == 'concat':      #todo is this relevent now?as multiply is done already, remove
